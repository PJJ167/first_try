...
class WorkordersControllerTest < ActionController::TestCase
  ...
  test "should create workorder" do
    assert_difference('Workorder.count') do
      post :create, workorder: { PID: @workorder.PID, assigned_equipment: @workorder.assigned_equipment, crewnum: @workorder.crewnum, hours: @workorder.hours }
    end
  ...
  test "should update workorder" do
    patch :update, id: @workorder, workorder: { PID: @workorder.PID, assigned_equipment: @workorder.assigned_equipment, crewnum: @workorder.crewnum, hours: @workorder.hours }
    assert_redirected_to workorder_path(assigns(:workorder))
  end
